...
local Library = getgenv().Library
print("[Library] getgenv().Library type:", type(Library))

if type(Library) ~= "table" then
	print("[Library] Library is not a table, creating new one")
	Library = {}

	getgenv().Library = Library
end

if type(Library.Window) ~= "function" then
	print("[Library] Library.Window is not a function, creating new one")
	Library = {}
	getgenv().Library = Library
end
...
getgenv().Library = Library
print("[Library] Successfully returning Library, Window type:", type(Library.Window))
return Library